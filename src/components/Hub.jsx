  ...
  return (
    <div className="view-enter" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#FFF8F0" }}>
      ...
      <div style={{ flex: 1, padding: "0 16px 100px" }}>
          ...
          <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
            ...
            <div style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              ...
              <div style={{ background: "#E0F2FE40", borderRadius: 14, padding: "8px 10px", display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Fredoka',sans-serif", fontSize: "1.05rem", fontWeight: 700, color: "#0284C7" }}>
        ...
        {/* --- 2b. Login Bonus Card (collapsible) --- */}
        <LoginBonus
        ...
        {tip && (
          <div className="game-card" style={{
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div>
                <div style={{
                  fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "1rem", fontWeight: 800,
                  color: "#B45309", textTransform: "uppercase", marginBottom: 4,
                }}>
                  Helden-Tipp von {tip.char}
                </div>
                <div style={{
                  fontFamily: "'Fredoka',sans-serif", fontSize: "1.15rem", fontWeight: 600,
          ...
          return (
            <div className="game-card" style={{ padding: 16, marginBottom: 12, background: "linear-gradient(135deg, rgba(239,68,68,0.06), rgba(249,115,22,0.04))", borderColor: "rgba(239,68,68,0.15)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                ...
                <div style={{ fontFamily: "'Fredoka',sans-serif", fontSize: "1rem", fontWeight: 700, color: hpPct > 50 ? "#DC2626" : hpPct > 25 ? T.accentDark : T.success }}>{state.boss.hp}/{state.boss.maxHp} HP</div>
              </div>
              ...
              <div style={{ fontSize: ".95rem", color: T.textLight, marginTop: 6, textAlign: "center" }}>Schlie\u00DFe Aufgaben ab, um den Boss anzugreifen!</div>
            </div>
          );
        })()}
        ...
        <button className="btn-tap" onClick={() => ui.setView("regeln")} style={{ width: "100%", background: "linear-gradient(135deg, rgba(251,191,36,0.08), rgba(245,158,11,0.04))", border: "2.5px solid rgba(245,158,11,0.15)", borderRadius: 18, padding: "14px 12px", cursor: "pointer", fontFamily: "'Fredoka',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "#B45309", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, minHeight: 52, boxShadow: "0 2px 8px rgba(0,0,0,0.04)", marginBottom: 12 }}>{"\uD83D\uDCDC"} Familienregeln</button>
