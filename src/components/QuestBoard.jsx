    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: "1 1 auto", background: "linear-gradient(180deg, #F0F4FF 0%, #FFFFFF 100%)", borderRadius: "32px 32px 0 0", padding: "0 16px 100px", overflow: "auto", animation: "slideUp .3s ease", boxShadow: "0 -8px 40px rgba(0,0,0,0.15)", position: "relative" }}>
                ...
                {qs.map(q => {
                  ...
                  return (
                    <button key={q.id} className={q.done ? "" : "btn-tap"} onClick={() => !q.done && !pMode && actions.complete(q.id)} disabled={q.done} style={{
                      ...
                      border: `2.5px solid ${grad ? T.accentDark + "30" : q.done ? T.success + "30" : "rgba(0,50,150,0.06)"}`,
                      ...
                      boxShadow: q.done ? "none" : "0 3px 12px rgba(0,40,120,0.06)",
                    }}>
        ...
        {pMode && <div style={{ background: "white", borderRadius: 22, padding: 16, border: `3px solid rgba(109,40,217,0.1)`, marginTop: 8, boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
          ...
          <button onClick={actions.togVac} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", background: "rgba(0,50,150,0.02)", border: `2.5px solid ${state.vacMode ? T.success + "40" : "rgba(0,50,150,0.06)"}`, borderRadius: 16, padding: "12px 14px", cursor: "pointer", marginBottom: 12, fontFamily: "'Nunito',sans-serif", minHeight: 48 }}>
