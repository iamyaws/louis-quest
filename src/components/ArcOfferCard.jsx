...
import FreundSpriteReunion from './FreundSpriteReunion';
 ...
 *
 * When the offered arc has `freundId` set, rendering delegates to
 * `FreundSpriteReunion` — a floating sprite overlay that replaces the
 * flat modal with a magical Hub entrance. Non-Freund arcs render the
 * standard offer card exactly as before — zero regression.
 */
