  ...
  return (
    <div className="view-enter" style={{ minHeight: "100vh", padding: "env(safe-area-inset-top, 12px) 20px 100px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10, marginBottom: 24 }}>
        {badges.map((b, i) => (
          <div key={i} style={{ background: b.u ? T.card : T.bg, border: b.u ? `2px solid ${T.primary}30` : T.cardBorder, borderRadius: 16, padding: "16px 8px", textAlign: "center", opacity: b.u ? 1 : .35, boxShadow: b.u ? `0 4px 12px ${T.primary}10` : "none" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        {[{ l: "Gesamt XP", v: state.xp, i: "\u26A1" }, { l: "M\u00FCnzen", v: state.coins, i: "\u{1FA99}" }, { l: "Quests", v: state.hist.length, i: "\u2694\uFE0F" }, { l: "Streak", v: state.sd + "d", i: "\u{1F525}" }, { l: "Level", v: level, i: "\u{1F4C8}" }].map((s, i) => (
          <div key={i} className="game-card" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderRadius: 14, padding: "14px 18px" }}>
