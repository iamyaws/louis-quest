  ...
  return (
    <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[300] animate-slide-in-toast pointer-events-none">
      <div className="flex items-center gap-3 px-5 py-3 rounded-full shadow-xl"
           style={{ background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(12px)', border: '1.5px solid rgba(83,0,183,0.12)' }}>
        ...
        <span className="font-headline font-bold text-sm text-on-surface whitespace-nowrap">{msg.text}</span>
      </div>
    </div>
  );
}
